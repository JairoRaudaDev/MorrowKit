...
## Corpus Check
- 88 files · ~21,599 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 425 nodes · 729 edges · 30 communities (24 shown, 6 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e0fa2eb2`
...
Cohesion: 0.15
Nodes (22): authErrorMessage(), login(), logout(), signup(), GET(), ProfileFormState, updateProfile(), initialState (+14 more)

### Community 8 - "dependencies"
Cohesion: 0.06
Nodes (33): class-variance-authority, clsx, lucide-react, next, dependencies, class-variance-authority, clsx, lucide-react (+25 more)

### Community 11 - "settings/page.tsx"
Cohesion: 0.11
Nodes (31): BillingPage(), formatDate(), planLabels, statusLabels, PremiumInsightsPage(), stats, AccountSettingsPage(), AuthPageProps (+23 more)
...
Cohesion: 0.13
Nodes (25): handledEvents, POST(), createBillingPortalSession(), DashboardLayout(), createCheckoutSession(), isPaidPlan(), PaidPlan, paidPlans (+17 more)
...
Cohesion: 0.27
Nodes (8): metadata, CTA(), Features, Footer(), Hero(), Navbar(), plans, Pricing()
...
- **Why does `cn()` connect `cn` to `settings/page.tsx`, `createClient`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `scripts`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `publicEnv` connect `public.ts` to `pricing/actions.ts`, `createClient`?**
