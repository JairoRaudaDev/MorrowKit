...
## Corpus Check
- 60 files · ~17,592 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 312 nodes · 503 edges · 21 communities (18 shown, 3 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5889e2e9`
...
### Community 1 - "cn"
Cohesion: 0.09
Nodes (35): AppShell(), AppShellProps, navigation, Logo(), LogoProps, Avatar(), AvatarBadge(), AvatarFallback() (+27 more)
