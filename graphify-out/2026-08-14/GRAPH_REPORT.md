...
## Corpus Check
- 54 files · ~15,976 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 286 nodes · 452 edges · 20 communities (17 shown, 3 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65849373`
...
### Community 1 - "cn"
Cohesion: 0.09
Nodes (23): Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup(), AvatarGroupCount(), AvatarImage(), DialogContent(), DialogDescription() (+15 more)
...
Cohesion: 0.25
Nodes (13): authErrorMessage(), login(), signup(), GET(), LoginPage(), LoginPageProps, Home(), SignupPage() (+5 more)
...
Cohesion: 0.13
Nodes (22): logout(), DashboardPage(), ProfileFormState, updateProfile(), AccountSettingsPage(), initialState, ProfileForm(), AppShell() (+14 more)
...
### Community 19 - "auth-page.tsx"
Cohesion: 0.27
Nodes (9): AuthForm(), AuthPageProps, Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader() (+1 more)
