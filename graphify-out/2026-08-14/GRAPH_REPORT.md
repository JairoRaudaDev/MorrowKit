...
## Corpus Check
- 79 files · ~20,817 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 394 nodes · 676 edges · 25 communities (21 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe55f5f1`
...
Cohesion: 0.14
Nodes (21): authErrorMessage(), login(), logout(), signup(), GET(), LoginPage(), LoginPageProps, SignupPage() (+13 more)

### Community 8 - "dependencies"
Cohesion: 0.07
Nodes (29): class-variance-authority, clsx, lucide-react, next, dependencies, class-variance-authority, clsx, lucide-react (+21 more)

### Community 11 - "billing/page.tsx"
Cohesion: 0.12
Nodes (25): BillingPage(), formatDate(), planLabels, statusLabels, PremiumInsightsPage(), stats, AuthPageProps, Card() (+17 more)
...
Cohesion: 0.12
Nodes (26): handledEvents, POST(), createBillingPortalSession(), DashboardLayout(), AccountSettingsPage(), createCheckoutSession(), isPaidPlan(), PaidPlan (+18 more)
