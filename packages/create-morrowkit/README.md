...
initialization, dependency installation, and whether to include Stripe and
transactional email. Each question has a simple default.
...
`--no-email` to override them. Disabling an integration removes its source,
